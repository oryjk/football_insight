...
#[derive(Debug, Clone)]
pub struct CompleteWechatLoginInput {
    pub code: String,
}

#[derive(Debug, Clone)]
pub enum WechatLoginResult {
...
pub struct CompleteWechatLoginUseCase {
...
impl CompleteWechatLoginUseCase {
    pub fn new(
        repository: Arc<dyn AuthRepository>,
        wechat_oauth_port: Arc<dyn WechatOauthPort>,
        token_port: Arc<dyn TokenPort>,
    ...
    pub async fn execute(
        &self,
        input: CompleteWechatLoginInput,
            ...
            .await?
        {
            ...
            return Ok(WechatLoginResult::Authenticated(AuthTokenBundle {
                user,
                access_token,
                expires_at,
            }));
        ...
        Ok(WechatLoginResult::BindingRequired {
            bind_token,
            expires_at,
            profile,
        })
